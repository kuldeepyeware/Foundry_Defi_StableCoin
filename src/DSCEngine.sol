...
contract DSCEngine is ReentrancyGuard {
    ...
    function depositColletralAndMintDsc(
        ...
        depositColletral(tokenCollateralAddress, amountCollateral);
        mintDsc(amountDscToMint);
    }

    /**
     * @param tokenColletralAddress The address of the token to redeem as collateral
     * @param amountColletral The amount of collateral to redeem
     * @param amountDscToBurn The amount of DSC to burn
     * This function burns DSC and redeems collateral in one transaction
     */
    function redeemColletralForDsc(address tokenColletralAddress, uint256 amountColletral, uint256 amountDscToBurn)
        external
    ...
    /**
     *
     * @param colletral The erc20 colletral address to liquidate from the user
     * @param user The user who has broken the health factor. Thier _healthFactor should be below MIN_HEALTH_FACTOR
     * @param debtToCover The amount of DSC you want to burn to improve the users health factor
     * @notice You can partially liquidate a user.
     * @notice You will get liquidation bonus for taking users funds
     * @notice This function working assumes the protocol will be roughly 200% overcollateralized in order for this to work
     * @notice A known bug would be if the protocol was only 100% collateralized or less, then we wouldn't be able to incentivies liquidators.
     */
        ...
        nonReentrant
    {
        ...
        uint256 totalColletralToRedeem = tokenAmountFromDebtCovered + bonusColletral;
        _redeemColletral(colletral, totalColletralToRedeem, user, msg.sender);
     ...
     * @param amountCollateral The amount of collateral to deposit
     */
    function depositColletral(address tokenCollateralAddress, uint256 amountCollateral)
        public
    ...
    function _redeemColletral(address tokenColletralAddress, uint256 amountColletral, address from, address to)
        ...
        nonReentrant
    {
        s_collateralDeposited[from][tokenColletralAddress] -= amountColletral;
        emit CollateralRedeemed(from, to, tokenColletralAddress, amountColletral);
     ...
     * If a user is below 1, then they can get liquidated
     */
